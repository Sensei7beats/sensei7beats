...
export default function Upload() {
  ...
  const handleSubmit = (e) => {
    ...
    // Later: Send to backend + detect key/BPM + save beat
  };
  ...
  return (
    <div style={{ backgroundColor: '#111', color: '#fff', minHeight: '100vh', padding: '2rem' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1rem', maxWidth: '500px' }}>
        ...
        <input name="bpm" value={beat.bpm} onChange={handleChange} placeholder="BPM" />
        <input name="key" value={beat.key} onChange={handleChange} placeholder="Key" />
